...
public class ZeroShotEvalCV {
    ...
    public double[] startCV(int folds,trainingDirection dir){
        ...
        for (int i=0;i<folds;i++){
            ...
            System.out.println("test concepts "+start_index+" "+end_index);
            ...
            System.out.println("train concepts "+trConcepts.size());
    ...
    private SimpleMatrix trainMapping(trainingDirection dir){
    ...
    public static void main(String[] args) {
        ...
        //evaluate mapping
        double[] ranks = exp.startCV(2,dir);
