...
//    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "bnc.ini";
    ...
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "i_neg_dwiki100is.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "i_neg_dwiki100is.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "i_neg_dwiki100is.mdl";
    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "i_neg_dwiki100is.ini";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "i_neg_dwiki100is.log";
