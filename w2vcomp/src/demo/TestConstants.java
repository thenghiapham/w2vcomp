...
//    public static final String S_VOCABULARY_FILE          = S_OUT_DIR + "bnc_lower_1.voc";
    ...
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "s_neg_istep_type_lwiki_size_window_function_wo_lex.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "s_neg_istep_type_lwiki_size_window_function_wo_lex.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "s_neg_istep_type_lwiki_size_window_function_wo_lex.mdl";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "s_neg_istep_type_lwiki_size_window_function_wo_lex.log";
    public static final String S_VOCABULARY_FILE          = S_OUT_DIR + "wiki_lower.voc";
    
//    public static final String S_VECTOR_FILE              = S_OUT_DIR + "s_neg_istep_type_lbnc_size_window_function_wo_lex.bin";
//    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "s_neg_istep_type_lbnc_size_window_function_wo_lex.cmp";
//    public static final String S_MODEL_FILE               = S_OUT_DIR + "s_neg_istep_type_lbnc_size_window_function_wo_lex.mdl";
//    public static final String S_LOG_FILE                 = S_LOG_DIR + "s_neg_istep_type_lbnc_size_window_function_wo_lex.log";
...
//    public static final String S_WORD_LOG_FILE            = S_LOG_DIR + "hs_skip_wiki_size.log";
    ...
    public static final String S_WORD_VECTOR_FILE         = S_OUT_DIR + "neg_skip_wiki_ws_size.bin";
    public static final String S_WORD_MODEL_FILE          = S_OUT_DIR + "neg_skip_wiki_ws_size.mdl";
    public static final String S_WORD_LOG_FILE            = S_LOG_DIR + "neg_skip_wiki_ws_size.log";
...
//    public static final String S_MEN_FILE                 = S_PROJECT_DIR + "men/MEN_dataset_lemma_form_test.txt";
    public static final String S_MEN_FILE                 = S_PROJECT_DIR + "men/MEN_dataset_lemma.txt";
    public static final String S_MEN_TEST_FILE            = S_PROJECT_DIR + "men/MEN_dataset_lemma_form_test.txt";
//  public static final String S_MEN_FILE                 = S_PROJECT_DIR + "men/MEN_dataset_lemma_form_full";
    ...
    public static final String S_SICK_TEST_FILE                = S_PROJECT_DIR + "sick/postprocessed/SICK_test.txt";
    public static final String S_ONWN1_FILE               = "/home/thenghiapham/work/dataset/processed_sts/STS.all.surprise.OnWN.txt";
    public static final String S_ONWN2_FILE               = "/home/thenghiapham/work/dataset/processed_sts/STS.all.OnWN.txt";
    ...
    public static final String WORD_SIM                   = "/home/thenghiapham/work/dataset/simlex/cleaned-wordsim_simrel_goldstandard.txt";
    public static final String WORD_SIM_RELATED           = "/home/thenghiapham/work/dataset/simlex/cleaned-wordsim_relatedness_goldstandard.txt";
    public static final String WORD_SIM_SIM               = "/home/thenghiapham/work/dataset/simlex/cleaned-wordsim_similarity_goldstandard.txt";
