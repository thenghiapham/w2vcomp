...
//    public static final String S_LOG_FILE                 = S_LOG_DIR + "dbnc300t.log";
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "s_neg_irwubnc40ts.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "s_neg_irwubnc40ts.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "s_neg_irwubnc40ts.mdl";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "s_neg_irwubnc40ts.log";
    public static final String S_VOCABULARY_FILE          = S_OUT_DIR + "bnc_upper.voc";
...
//    
//    public static final String S_VECTOR_FILE              = S_OUT_DIR + "i_hs_wiki_size.bin";
//    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "i_hs_wiki_size.cmp";
//    public static final String S_MODEL_FILE               = S_OUT_DIR + "i_hs_wiki_size.mdl";
//    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "i_hs_wiki_size.ini";
