...
//    public static final String S_VECTOR_FILE              = S_OUT_DIR + "s_neg_dbnc40ts.bin";
//    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "s_neg_dbnc40ts.cmp";
//    public static final String S_MODEL_FILE               = S_OUT_DIR + "s_neg_dbnc40ts.mdl";
//    public static final String S_LOG_FILE                 = S_LOG_DIR + "s_neg_dbnc40ts.log";
...
//    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "bnc.ini";
    ...
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "i_neg_dwiki40is.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "i_neg_dwiki40is.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "i_neg_dwiki40is.mdl";
    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "i_neg_dwiki40is.ini";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "i_neg_dwiki40is.log";
    public static final String S_VOCABULARY_FILE          = S_OUT_DIR + "i_neg_dwiki40is.voc";
