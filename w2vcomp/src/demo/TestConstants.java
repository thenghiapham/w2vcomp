...
//    public static final String S_LOG_FILE                 = S_LOG_DIR + "dbnc300t.log";
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "wbnc300t.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "wbnc300t.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "wbnc300t.mdl";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "wbnc300t.log";
