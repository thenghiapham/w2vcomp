...
public class TestConstants {
        ...
        public static int wordDimensions = 10;
        public static int imageDimensions = 10;
        ...
        public static String typeOfLearning = "ts_v3";
        ...
        //parallel data
         public static String SOURCE_FILE_TRAIN                  = ROOT_EXP_DIR+"corpus/extended_v2_version/cds.11_24.words_more.txt";
        //public static String SOURCE_FILE_TRAIN                    = ROOT_EXP_DIR+"corpus/extended_v2_version/words.txt";
        public static String SOURCE_FILE_TEST                  = ROOT_EXP_DIR+"corpus/extended_v2_version/words.txt";
        public static String TARGET_FILE_TRAIN                  = ROOT_EXP_DIR+"corpus/extended_v2_version/cds.11_24.images_more.txt";
        //public static String TARGET_FILE_TRAIN                = ROOT_EXP_DIR+"corpus/extended_v2_version/objects.txt";
        public static String TARGET_FILE_TEST                  = ROOT_EXP_DIR+"corpus/extended_v2_version/objects.txt";
