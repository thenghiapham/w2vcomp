...
//    public static final String S_LOG_FILE                 = S_LOG_DIR + "dbnc300t.log";
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "s_neg_aubnc40ts.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "s_neg_aubnc40ts.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "s_neg_aubnc40ts.mdl";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "s_neg_aubnc40ts.log";
