...
//    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "bnc.ini";
    ...
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "i_neg_wiki40ts.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "i_neg_wiki40ts.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "i_neg_wiki40ts.mdl";
    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "i_neg_wiki40ts.ini";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "i_neg_wiki40ts.log";
