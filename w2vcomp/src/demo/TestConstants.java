...
//    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "wbnc.ini";
    ...
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "skip_wiki300.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "skip_wiki300.cmp";
    public static final String S_VOCABULARY_FILE          = S_OUT_DIR + "skip_wiki300.voc";
    public static final String S_INITIALIZATION_FILE      = S_OUT_DIR + "skip_wiki300.ini";
  
    public static final String S_LOG_DIR                  = S_PROJECT_DIR + "log/";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "skip_wiki300.log";
