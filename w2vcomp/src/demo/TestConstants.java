...
//    public static final String S_VOCABULARY_FILE          = S_OUT_DIR + "bnc_lower_1.voc";
    ...
    public static final String S_VECTOR_FILE              = S_OUT_DIR + "s_neg_i4wlwiki40is_wo_lex.bin";
    public static final String S_COMPOSITION_FILE         = S_OUT_DIR + "s_neg_i4wlwiki40is_wo_lex.cmp";
    public static final String S_MODEL_FILE               = S_OUT_DIR + "s_neg_i4wlwiki40is_wo_lex.mdl";
    public static final String S_LOG_FILE                 = S_LOG_DIR + "s_neg_i4wlwiki40is_wo_lex.log";
