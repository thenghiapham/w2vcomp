...
public class NewDiagonalSOTreeNetwork extends NewDiagonalTreeNetwork{

    protected NewDiagonalSOTreeNetwork(Tree parseTree) {
        super(parseTree);
    ...
    public static NewDiagonalSOTreeNetwork createNetwork(Tree parseTree, Tree rootTree, 
        ...
        NewDiagonalSOTreeNetwork network = new NewDiagonalSOTreeNetwork(parseTree);
