...
public class SingleObjTreeNetwork extends TreeNetwork{
    ...
    public static SingleObjTreeNetwork createNetwork(Tree parseTree, Tree rootTree, 
        ...
        network.addOutputLayers(rootTree, outputBuilder, outputLayerActivation, maxWindowSize);
    ...
    protected void addOutputLayers(Tree rootTree, LearningStrategy outputBuilder, 
            ActivationFunction outputLayerActivation, int maxWindowSize) {

        // get the 
        String[] sentence = rootTree.getSurfaceWords();
