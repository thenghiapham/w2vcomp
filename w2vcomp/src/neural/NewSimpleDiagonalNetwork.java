 ...
 *
 */
public class NewSimpleDiagonalNetwork {
    ...
    protected NewSimpleDiagonalNetwork(Tree parseTree) {
    ...
    public static NewSimpleDiagonalNetwork createComposingNetwork(Tree parseTree,
            ProjectionMatrix projectionBuilder,
            NewDiagonalCompositionMatrices hiddenBuilder, ActivationFunction hiddenLayerActivation) {
        // TODO Auto-generated method stub
        NewSimpleDiagonalNetwork network = new NewSimpleDiagonalNetwork(parseTree);
    ...
    protected void addHiddenLayer(NewDiagonalLayer layer, int compositionIndex) {
