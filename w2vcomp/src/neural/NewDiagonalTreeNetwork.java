...
import neural.layer.NewDiagonalLayer;
 ...
 *
 */
public class NewDiagonalTreeNetwork {
    private static final Logger LOGGER = Logger.getLogger(NewDiagonalTreeNetwork.class.getName());
...
//    private static final double LEVEL_DECAY = 1;
    ...
    protected ArrayList<NewDiagonalLayer> hiddenLayers;
     ...
     * @param parseTree
     */
    protected NewDiagonalTreeNetwork(Tree parseTree) {
     ...
     */
    public static NewDiagonalTreeNetwork createNetwork(Tree parseTree, ProjectionMatrix projectionBuilder, 
...
//        System.out.println("parse tree: " + parseTree.toPennTree());
        ...
        NewDiagonalTreeNetwork network = new NewDiagonalTreeNetwork(parseTree);
            ...
            if (node.isPreTerminal()) {
                ...
                if (outputLayerHeight == -1 || node.getHeight() <= outputLayerHeight) {
                    ...
                    if (children.size() == 1) {
                        ...
                        layer = new NewDiagonalLayer(weights, hiddenLayerActivation);
                        ...
                        network.addHiddenLayer((NewDiagonalLayer) layer, compositionIndex);
                    }
                }
            }
            if (layer != null) {
...
//            System.exit(0);
     ...
     */
    public void addHiddenLayer(NewDiagonalLayer layer, int compositionIndex) {
...
//                System.out.println("Good error " + getLayerType(i));
    ...
    protected ArrayList<SimpleMatrix> computeRealGradient() {
        ...
        for (NewDiagonalLayer layer: hiddenLayers) {
            gradients.add(layer.getGradient());
        }
