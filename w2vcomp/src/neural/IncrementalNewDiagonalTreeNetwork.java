...
public class IncrementalNewDiagonalTreeNetwork extends NewDiagonalTreeNetwork{
//    public static final int INCREASE_STEP = 4;
    protected int incrementalStep;
    protected IncrementalNewDiagonalTreeNetwork(Tree parseTree, int incrementalStep) {
        super(parseTree);
    ...
    public static IncrementalNewDiagonalTreeNetwork createNetwork(Tree parseTree, Tree rootTree, 
            String[] historyPresentFuture, Vocab vocab, ProjectionMatrix projectionBuilder, 
            NewDiagonalCompositionMatrices hiddenBuilder, LearningStrategy outputBuilder,
        ...
        IncrementalNewDiagonalTreeNetwork network = new IncrementalNewDiagonalTreeNetwork(parseTree, incrementalStep);
