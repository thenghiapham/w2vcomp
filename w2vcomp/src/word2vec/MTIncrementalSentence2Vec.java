...
public class MTIncrementalSentence2Vec extends Sentence2Vec{
    private static final Logger LOGGER = Logger.getLogger(MTIncrementalSentence2Vec.class.getName());
