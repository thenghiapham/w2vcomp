...
import neural.IncrementalNewDiagonalTreeNetwork;
...
public class MTIncrementalNewDiagonalSentence2Vec extends MTIncrementalSentence2Vec{

    public MTIncrementalNewDiagonalSentence2Vec(int hiddenLayerSize, int windowSize,
...
//        Collections.reverse(reversedNodes);
        for (Tree subTree: reversedNodes) {
            ...
            IncrementalNewDiagonalTreeNetwork network = IncrementalNewDiagonalTreeNetwork.createNetwork(subTree, parseTree, historyPresentFuture,
                    vocab, projectionMatrix, (NewDiagonalCompositionMatrices) compositionMatrices, learningStrategy, hiddenActivationFunction, 
