...
public class OppositeWord2Vec extends MultiThreadWord2Vec{
    ...
    public OppositeWord2Vec(int projectionLayerSize, int windowSize,
 ...
 /*************    FOR SECOND MODALITY   ****************/
    ...
    //                mmWordsPerRun++;
                    ...
                    int k=0;
                    for (int index = 0; index < synonymSamples; index++) {
                        int synonymIndex;

                        synonymIndex = unigram.randomWordIndex();
                        if (synonymIndex == 0) {
                            synonymIndex = rand.nextInt(vocab.getVocabSize() - 1) + 1;
                        }
                        if (synonymIndex == iWordIndex)
                            continue;
